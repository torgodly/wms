        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 ">
                    <form action="{{ route('product.update', ['warehouse' => $warehouse->id, 'product'=>$product->id]) }}" method="POST">
                        @csrf
                        @method('PATCH')
                        <div class="flex flex-col">
                            <div class="mb-4">
                                ...
                                <input class="border rounded w-full py-2 px-3 text-gray-700 mt-1 leading-tight focus:outline-none focus:shadow-outline"
                                       id="name" name="name" type="text" placeholder="Warehouse Name" value="{{$product->name}}">
                            </div>
                            <div class="mb-4">
                                <label class="font-bold text-gray-800" for="code">code</label>
                                <input class="border rounded w-full py-2 px-3 text-gray-700 mt-1 leading-tight focus:outline-none focus:shadow-outline"
                                       id="code" name="code" type="text" placeholder="Product code" value="{{$product->code}}">
                            </div>
                            <div class="mb-4">
                                ...
                                <input
                                    ...
                                    id="description" name="description" type="text" placeholder="Product description" value="{{$product->description}}">
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input
                                    class="border rounded w-full py-2 px-3 text-gray-700 mt-1 leading-tight focus:outline-none focus:shadow-outline"
                                    id="price" name="price" type="text" placeholder="Product price" value="{{$product->price}}">
                            </div>
